...
mixin _$UserModel {
 ...
 String get token; int get id; String get name; String get email; List<TicketModel>? get tickets;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserModel&&(identical(other.token, token) || other.token == token)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&const DeepCollectionEquality().equals(other.tickets, tickets));
}
...
@override
String toString() {
  return 'UserModel(token: $token, id: $id, name: $name, email: $email, tickets: $tickets)';
}
...
@useResult
$Res call({
 String token, int id, String name, String email, List<TicketModel>? tickets
});
...
class _UserModel extends UserModel {
  const _UserModel({required this.token, required this.id, required this.name, required this.email, final  List<TicketModel>? tickets}): _tickets = tickets,super._();
...
@override List<TicketModel>? get tickets {
