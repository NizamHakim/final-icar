...
mixin _$Ticket {
 ...
 int get id; DateTime get arrivedAt; DateTime get expiredAt; TicketStatus get status; int get userId; int get scheduleId; User? get user; Schedule? get schedule; Review? get review;
...
@override
String toString() {
  return 'Ticket(id: $id, arrivedAt: $arrivedAt, expiredAt: $expiredAt, status: $status, userId: $userId, scheduleId: $scheduleId, user: $user, schedule: $schedule, review: $review)';
}
...
@useResult
$Res call({
 int id, DateTime arrivedAt, DateTime expiredAt, TicketStatus status, int userId, int scheduleId, User? user, Schedule? schedule, Review? review
});
...
class _Ticket extends Ticket {
  const _Ticket({required this.id, required this.arrivedAt, required this.expiredAt, required this.status, required this.userId, required this.scheduleId, this.user, this.schedule, this.review}): super._();
