...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReviewModel&&(identical(other.rating, rating) || other.rating == rating)&&const DeepCollectionEquality().equals(other.review, review)&&(identical(other.suggestion, suggestion) || other.suggestion == suggestion));
}
...
@override
String toString() {
  return 'ReviewModel(rating: $rating, review: $review, suggestion: $suggestion)';
}
...
class _ReviewModel extends ReviewModel {
  const _ReviewModel({required this.rating, required final  List<String> review, required this.suggestion}): _review = review,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReviewModel&&(identical(other.rating, rating) || other.rating == rating)&&const DeepCollectionEquality().equals(other._review, _review)&&(identical(other.suggestion, suggestion) || other.suggestion == suggestion));
}
