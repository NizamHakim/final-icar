...
mixin _$NotificationPayload {
 ...
 NotificationType get type; int get ticketId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationPayload&&(identical(other.type, type) || other.type == type)&&(identical(other.ticketId, ticketId) || other.ticketId == ticketId));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,ticketId);

@override
String toString() {
  return 'NotificationPayload(type: $type, ticketId: $ticketId)';
}
...
@useResult
$Res call({
 NotificationType type, int ticketId
});
...
/// Create a copy of NotificationPayload
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? ticketId = null,}) {
  return _then(_self.copyWith(
type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as NotificationType,ticketId: null == ticketId ? _self.ticketId : ticketId // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
class _NotificationPayload extends NotificationPayload {
  const _NotificationPayload({required this.type, required this.ticketId}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NotificationPayload&&(identical(other.type, type) || other.type == type)&&(identical(other.ticketId, ticketId) || other.ticketId == ticketId));
}
...
/// Create a copy of NotificationPayload
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? ticketId = null,}) {
