...
mixin _$Schedule {
 ...
 int get id; ScheduleSession get session; DateTime get arrivalTime; int get icarId; int get icarStopId; Icar? get icar; IcarStop? get icarStop; List<Ticket>? get tickets;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Schedule&&(identical(other.id, id) || other.id == id)&&(identical(other.session, session) || other.session == session)&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.icarId, icarId) || other.icarId == icarId)&&(identical(other.icarStopId, icarStopId) || other.icarStopId == icarStopId)&&(identical(other.icar, icar) || other.icar == icar)&&(identical(other.icarStop, icarStop) || other.icarStop == icarStop)&&const DeepCollectionEquality().equals(other.tickets, tickets));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,session,arrivalTime,icarId,icarStopId,icar,icarStop,const DeepCollectionEquality().hash(tickets));

@override
String toString() {
  return 'Schedule(id: $id, session: $session, arrivalTime: $arrivalTime, icarId: $icarId, icarStopId: $icarStopId, icar: $icar, icarStop: $icarStop, tickets: $tickets)';
}
...
@useResult
$Res call({
 int id, ScheduleSession session, DateTime arrivalTime, int icarId, int icarStopId, Icar? icar, IcarStop? icarStop, List<Ticket>? tickets
});
...
/// Create a copy of Schedule
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? session = null,Object? arrivalTime = null,Object? icarId = null,Object? icarStopId = null,Object? icar = freezed,Object? icarStop = freezed,Object? tickets = freezed,}) {
...
as IcarStop?,tickets: freezed == tickets ? _self.tickets : tickets // ignore: cast_nullable_to_non_nullable
as List<Ticket>?,
  ));
}
/// Create a copy of Schedule
...
class _Schedule extends Schedule {
  const _Schedule({required this.id, required this.session, required this.arrivalTime, required this.icarId, required this.icarStopId, this.icar, this.icarStop, final  List<Ticket>? tickets}): _tickets = tickets,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Schedule&&(identical(other.id, id) || other.id == id)&&(identical(other.session, session) || other.session == session)&&(identical(other.arrivalTime, arrivalTime) || other.arrivalTime == arrivalTime)&&(identical(other.icarId, icarId) || other.icarId == icarId)&&(identical(other.icarStopId, icarStopId) || other.icarStopId == icarStopId)&&(identical(other.icar, icar) || other.icar == icar)&&(identical(other.icarStop, icarStop) || other.icarStop == icarStop)&&const DeepCollectionEquality().equals(other._tickets, _tickets));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,session,arrivalTime,icarId,icarStopId,icar,icarStop,const DeepCollectionEquality().hash(_tickets));
...
/// Create a copy of Schedule
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? session = null,Object? arrivalTime = null,Object? icarId = null,Object? icarStopId = null,Object? icar = freezed,Object? icarStop = freezed,Object? tickets = freezed,}) {
...
as int,icar: freezed == icar ? _self.icar : icar // ignore: cast_nullable_to_non_nullable
as Icar?,icarStop: freezed == icarStop ? _self.icarStop : icarStop // ignore: cast_nullable_to_non_nullable
as IcarStop?,tickets: freezed == tickets ? _self._tickets : tickets // ignore: cast_nullable_to_non_nullable
as List<Ticket>?,
  ));
}
